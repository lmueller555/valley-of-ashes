...
def main():
    ...
    starting_counts = {"GRUNT": 10, "LIEUTENANT": 5, "HEALER": 1, "BULWARK": 1}
    battlefield.seed_lane_wave("PLAYER", starting_counts)
    battlefield.seed_lane_wave("ENEMY", starting_counts)
